  ...
  conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: 'AryBOT',
        thumbnailUrl: "https://telegra.ph/file/b8a7b1262c5c962b8fe61.jpg",
        sourceUrl: "https://chat.whatsapp.com/Kv1YLUTrMys1M9RTuGBVDE",
        mediaType: 1,
...
break
            case 'sc':
            case 'script':
               newReply(`Script Bot ${namabot} https://youtube.com/@itsukabotz`)
            break
        // Group Fitur
            case 'antilinkv2':
                if (!m.isGroup) return newReply(mess.group)
